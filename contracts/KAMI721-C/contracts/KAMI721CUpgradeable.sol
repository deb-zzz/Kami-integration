 ...
 * @dev Upgradeable ERC721 contract with ERC20 payments, programmable royalties, platform commission, and rental functionality.
 ...
 *
 * Storage:
 * - Only _transferTracker and __gap are stored here; all other config is managed by KamiNFTLibrary via storage slots.
 */
    ...
    PausableUpgradeable
{
     ...
     * @param mintPrice_ Initial mint price (in payment token)
